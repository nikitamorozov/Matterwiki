...
class EditUser extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {loading: true, name: "", role: "user", about: "", email: "", password: ""}
  }

  handleChange() {
    this.setState({
      name: this.refs.user_name.value,
      role: this.refs.user_role.value,
  ...
  editUser(e) {
    ...
    var myInit = {
      method: 'PUT',
      headers: myHeaders,
      body: "name=" + user.name + "&about=" + user.about + "&role=" + user.role + "&email=" + user.email + "&password=" + user.password + "&id=" + user.id
    };
    var that = this;
              ...
              <form>
                ...
                <div className="col-sm-12 form-group">
                  <select type="text" className="form-control" ref="user_role" id="selectUserRole"
                          placeholder="Role">
                    <option value="user" selected={this.state.role === 'user' ? 'selected' : ''}>User</option>
                    <option value="admin" selected={this.state.role === 'admin' ? 'selected' : ''}>Admin</option>
                  </select>
                </div>
                <div className="col-sm-12 form-group">
                ...
                <div className="col-sm-12 form-group">
                  <input type="text" className="form-control" ref="user_email" id="inputUserName" placeholder="Email"
                         value={this.state.email} onChange={this.handleChange}/>
                </div>
                <div className="col-sm-12 form-group">
                  <input type="password" className="form-control" ref="user_password" id="inputUserName"
