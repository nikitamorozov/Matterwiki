...
class Admin extends React.Component {
  ...
  addUser(e) {
    var user = {
      ...
      role: encodeURIComponent(this.refs.user_role.value),
    ...
    var myInit = {
      method: 'POST',
      headers: myHeaders,
      body: "name=" + user.name + "&about=" + user.about + "&role=" + user.role + "&email=" + user.email + "&password=" + user.password
    };
    var that = this;
    fetch('/api/users/', myInit)
      .then(function (response) {
    ...
    if (this.state.loading_users && this.state.loading_users)
      ...
      return (
        <div>
                  ...
                  <div key={topic.id} href="#" className="list-group-item">
                    {(topic.id !== 1) ? <span className="pull-right">
                      ...
                      <button className="btn btn-default" type="button"
                              onClick={(e) => this.deleteTopic(topic.id, e)}>Delete</button>
                      </span> : ''}
          ...
          <div className="modal modal-fullscreen fade" id="addUser" tabIndex="-1" role="dialog"
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-6 col-sd-12">
                        ...
                        <form>
                          ...
                          <div className="col-sm-12 form-group">
                            <select type="text" className="form-control" ref="user_role" id="selectUserRole"
                                   placeholder="Role">
                          ...
                          <div className="col-sm-12 form-group">
                            <button onClick={this.addUser} className="btn btn-default btn-block btn-lg">Add User
                            </button>
                          </div>
                        </form>
                      </div>
          ...
          <div className="modal modal-fullscreen fade" id="addTopic" tabIndex="-1" role="dialog"
               aria-labelledby="myModalLabel">
            <div className="modal-dialog" role="document">
              <div className="modal-content">
                <div className="modal-header">
                  ...
                  <center>
                    <div className="row">
                      ...
                      <div className="col-md-6 col-sd-12">
                        ...
                        <form>
                          <div className="col-sm-12 form-group">
                            <input type="text" className="form-control" ref="topic_name" id="inputTopicName"
                                   placeholder="Name"/>
                          </div>
                          <div className="col-sm-12 form-group">
                            <input type="text" className="form-control" ref="topic_description" id="inputTopicAbout"
                                   placeholder="Description"/>
                          </div>
                          <div className="col-sm-12 form-group">
                            <button onClick={this.addTopic} className="btn btn-default btn-block btn-lg">Add Topic
                            </button>
                          </div>
                        </form>
                      </div>
